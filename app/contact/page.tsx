...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="relative py-16 sm:py-20 md:py-32 overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="relative overflow-hidden rounded-[32px] p-6 sm:p-8 md:p-16 shadow-[0_60px_160px_-30px_rgba(0,0,0,0.85)] border border-white/20 backdrop-blur-3xl bg-black/40">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 max-w-7xl mx-auto items-start">
                    ...
                    <div className="space-y-8">
                      ...
                      {[
                        ...
                        <div key={i} className="flex items-start gap-4 sm:gap-6">
                          ...
                          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/10 text-accent rounded-full flex items-center justify-center shrink-0 backdrop-blur-md">
                            <item.icon size={22} />
                          </div>
                ...
                <div className="lg:col-span-3">
                  ...
                  <AnimatedSection delay={0.1}>
                    ...
                    <p className="text-slate-300 mb-8 md:mb-12">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6 md:space-y-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-5 md:gap-8">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 md:px-6 md:py-5 rounded-2xl border border-white/20 bg-white/10 text-white placeholder:text-slate-400 focus:ring-2 focus:ring-accent/40 focus:border-accent outline-none transition backdrop-blur-sm"
                          />
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 md:px-6 md:py-5 rounded-2xl border border-white/20 bg-white/10 text-white placeholder:text-slate-400 focus:ring-2 focus:ring-accent/40 focus:border-accent outline-none transition resize-none backdrop-blur-sm"
                        />

                        <button
                          type="submit"
                          disabled={formStatus === "submitting"}
                          className="w-full bg-gradient-to-r from-primary to-accent text-white py-4 md:py-5 rounded-2xl font-semibold hover:shadow-xl transition flex justify-center items-center gap-3"
                        >
