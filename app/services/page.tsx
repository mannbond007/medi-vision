        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
          <AnimatedSection>
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto font-light leading-relaxed">
              ...
              journey to global education as smooth and successful as possible.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <AnimatedSection className="max-w-3xl mx-auto bg-slate-50 border border-slate-100 p-12 rounded-3xl shadow-sm">
            ...
            <p className="text-slate-600 mb-8">
              Every student's profile is unique. Contact us to discuss your
              specific requirements and get a tailored application strategy.
            </p>

            <a
              href="/contact"
              className="inline-block bg-primary text-white font-medium px-8 py-3 rounded-xl hover:bg-slate-800 transition-colors"
            >
